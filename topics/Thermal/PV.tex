...
% Title
\title{Thermodynamics: P-V Process Problems}
\author{Gemini}
\date{\today}
...
\section*{Problem 1: Isobaric Expansion (Constant Pressure)}
...
$W = P \Delta V = (2 \times 10^5 \, \text{Pa}) \times (0.10 \, \text{m}^3) = \mathbf{20,000 \, J}$
...
$\Delta U = n C_V \Delta T = (2) \left(\frac{5}{2} R\right) (T_2 - T_1) \approx \mathbf{50,000 \, J}$
\paragraph{3. Heat Supplied ($Q$)}
$Q = \Delta U + W = 50,000 \, \text{J} + 20,000 \, \text{J} = \mathbf{70,000 \, J}$
\begin{center}
\begin{tikzpicture}
    \begin{axis}[
        title={P-V Diagram: Isobaric Expansion},
        xlabel={Volume $V$ (\si{m^3})},
        ylabel={Pressure $P$ (\si{Pa})},
...
\section*{Problem 2: Isothermal Compression (Constant Temperature)}
...
\begin{tikzpicture}
    \begin{axis}[
        title={P-V Diagram: Isothermal Compression},
        xlabel={Volume $V$ (\si{m^3})},
        ylabel={Pressure $P$ (\si{Pa})},
        xlabel style={at={(axis description cs:0.5,-0.15)},anchor=north},
        ylabel style={at={(axis description cs:-0.15,0.5)},anchor=south,rotate=90},
...
\section*{Problem 3: Adiabatic Expansion}
...
\begin{tikzpicture}
    \begin{axis}[
        title={P-V Diagram: Adiabatic Expansion},
        xlabel={Volume $V$ (\si{m^3})},
        ylabel={Pressure $P$ (\si{Pa})},
        xlabel style={at={(axis description cs:0.5,-0.15)},anchor=north},
        ylabel style={at={(axis description cs:-0.15,0.5)},anchor=south,rotate=90},
...
\section*{Problem 4: Isochoric Heating (Constant Volume)}
...
\begin{tikzpicture}
    \begin{axis}[
        title={P-V Diagram: Isochoric Heating},
        xlabel={Volume $V$ (\si{m^3})},
        ylabel={Pressure $P$ (\si{Pa})},
        xlabel style={at={(axis description cs:0.5,-0.15)},anchor=north},
        ylabel style={at={(axis description cs:-0.15,0.5)},anchor=south,rotate=90},
...
\section*{Problem 5: A Four-Process Thermodynamic Cycle}
